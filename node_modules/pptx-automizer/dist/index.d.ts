...
import { Border, Color, HyperlinkInfo, ImageStyle, ReplaceText, TextStyle } from './types/modify-types';
...
export type { ChartBubble, ChartCategory, ChartSeries, TableData, TableRow, TextStyle, ImageStyle, ModifyTableParams, TableRowStyle, ChartData, ChartValueStyle, Color, Border, ShapeValueStyle, ShapeCoordinates, ReplaceText, HyperlinkInfo, };
export { Automizer, XmlHelper, ModifyHelper, ModifyShapeHelper, ModifyCleanupHelper, ModifyTableHelper, ModifyChartHelper, ModifyTextHelper, ModifyColorHelper, ModifyImageHelper, LabelPosition, };
export declare const modify: {
    ...
    setMultiText: (paragraphs: import("./interfaces/imulti-text").MultiTextParagraph[]) => (element: Element, relation?: Element) => void;
    htmlToMultiText: (html: string) => (element: Element, relation?: Element) => void;
    ...
    setHyperlinkTarget: (target: string | number, isExternal?: boolean) => ShapeModificationCallback;
    addHyperlink: (target: string | number, isInternalLink?: boolean) => ShapeModificationCallback;
