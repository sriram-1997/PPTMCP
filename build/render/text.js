...
function resolveFontScale(regionName, theme) {
...
function resolveTextStyle(regionName, style, theme, defaultColor, contextLabel) {
...
export function renderTextElement(slide, shapeType, element) {
    if (element.boxStyle) {
