...
function intersectRayWithBox(anchor, box) {
...
function resolveConnectorGeometry(element, slideIndex, warnings, hardErrors) {
...
function resolveEdgeGeometry(element, slideIndex, warnings, hardErrors) {
    const start = roundPoint(element.start);
    const end = roundPoint(element.end);
    const lineRectResult = normalizeLineRect(start, end);
    if (lineRectResult.error) {
...
function resolveCalloutLeaderGeometry(element, slideIndex, warnings, hardErrors) {
