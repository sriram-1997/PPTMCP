...
function loadRegistry() {
    ...
    const raw = JSON.parse(fs.readFileSync(ICON_REGISTRY_PATH, "utf-8"));
    const entries = raw && typeof raw === "object" && "icons" in raw && raw.icons && typeof raw.icons === "object"
        ? raw.icons
        : raw;
    registryCache = entries;
    return entries;
}
function injectColor(svg, color) {
