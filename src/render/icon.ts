...
function resolveIconColor(slot: IconElement["colorSlot"], theme: ConcreteTheme): string {
...
function resolveAlign(value: IconElement["align"] | undefined): "left" | "center" | "right" {
...
function resolveVerticalAlign(value: IconElement["verticalAlign"] | undefined): "top" | "middle" | "bottom" {
...
export function prepareIconElement(args: {
  ...
  if (!Number.isFinite(sizePt) || (sizePt as number) <= 0) {
...
export function renderIconElement(slide: any, shapeType: any, element: PreparedIconElement): void {
  if (element.boxStyle) {
